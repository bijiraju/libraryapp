...
{   
    ...
    else if (spassword.value == "")
    {
        ...
        spasswordtext.innerHTML = 'Password should be of minimum 8 characters,at least 1 uppercase,1 lower case, must contain at least 1 number and 1 special character';
